...
urlpatterns = [
    ...
    path('<int:app_id>/response/skill/<int:skill_id>', views.get_skill_responce, name="get_skill_responce"),
     ...
     path('add-contactus', views.addconatctus, name="addconatctus"),
     path('update-contactus/<int:id>', views.updateconatctus, name="updateconatctus"),
     path('view-contactus', views.viewconatctus, name="viewconatctus"),
     path('view-contactus/<int:id>', views.viewconatctusone, name="viewconatctus"),
